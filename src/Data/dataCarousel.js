...
export const productData = [
  {
    id: 1,
    imageurl:
      "https://images.unsplash.com/photo-1564121211835-e88c852648ab?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80",
    name: "Mental Health Companion",
    description: "Some text about the product..",
    link:`https://www.google.com/search?q=mental+health&rlz=1C1VDKB_enIN943IN943&sxsrf=APwXEddwHXy2XGknOFA43zsqw1lQJS0E7w%3A1683475350331&ei=lstXZP3cE43b4-EP2oCYmAM&ved=0ahUKEwj9__mxyuP-AhWN7TgGHVoABjMQ4dUDCA8&oq=mental+health&gs_lcp=&sclient=gws-wiz`,
  ...
  },
  {
    id: 2,
    imageurl:
      "https://images.unsplash.com/photo-1525120334885-38cc03a6ec77?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80",
    name: "Depression",
    description: "Some text about the product..",
    link:`https://www.google.com/search?q=depression&rlz=1C1VDKB_enIN943IN943&sxsrf=APwXEdd0BOVpkZ71mDvwJAlmeypWFvQGxA%3A1683475356726&ei=nMtXZLn-K5Te4-EPguuK4A0&oq=depre&gs_lcp=&sclient=gws-wiz-serp`,
  ...
  },
  {
    id: 3,
    imageurl:
      "https://images.unsplash.com/photo-1541199249251-f713e6145474?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80",
    name: "Post Traumatic Stress Disorder(PTSD)",
    description: "Some text about the product..",
    link:`https://www.google.com/search?q=ptsd&rlz=1C1VDKB_enIN943IN943&sxsrf=APwXEdfy0uVx741imobek90NfIwGRUpHrA%3A1683475495470&ei=J8xXZK6vHJr14-EPoPagwAM&ved=0ahUKEwju3pT3yuP-AhWa-jgGHSA7CDgQ4dUDCA8&uact=5&oq=ptsd&gs_lcp=&sclient=gw
    `,
  ...
  },
  {
    id: 4,
    imageurl:
      "https://images.unsplash.com/photo-1604208485423-f19bc2aaae2d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80",
    name: "Anxiety",
    description: "Some text about the product..",
    link:`https://www.google.com/search?q=anxiety&rlz=1C1VDKB_enIN943IN943&sxsrf=APwXEddUXXRW9oWeUjrqX9fVhAHBSEIwkw%3A1683475579764&ei=e8xXZJuWLvLY4-EP8auq0Ak&oq=anxier&gs_lcp=
    `,
  ...
  },
  {
    ...
    description: "Some text about the product..",
    link:`https://www.google.com/search?q=adhd&rlz=1C1VDKB_enIN943IN943&sxsrf=APwXEdfixfZUAxGBW1a2rFrHa_cfcrHVmA%3A1683475611379&ei=m8xXZLfVFuWXjuMPgKWi6Ag&ved=0ahUKEwj3jreuy-P-AhXli2MGHYCSCI0Q4dUDCA8&uact=5&oq=adhd&gs_lcp=Cgxnd3Mtd2l6LXNlcnAQAzIKCAAQigUQsQMQQzIKCAAQigUQsQMQQzIKCAAQigUQsQMQQzIHCAAQigUQQzIKCAAQigUQsQMQQzIHCAAQigUQQzIICAAQgAQQsQMyCggAEIoFELEDEEMyBwgAEIoFEEMyBwgAEIoFEEM6BwgjEOoCECc6BwgjEIoFECc6BAgjECc6BQgAEIAESgQIQRgAUL4EWMgLYMgOaAFwAXgAgAG5AYgB_gSSAQMwLjSYAQCgAQGwAQrAAQE&sclient=gws-wiz-ser
    `,
  ...
  },
  {
    id: 6,
    imageurl:
      "https://img.freepik.com/free-photo/sad-man-holding-head-with-hand_1150-6345.jpg?w=1060&t=st=1680095605~exp=1680096205~hmac=fe60d67e0b141fdfe722eee9fce3eddd8384c593734decaf843b02a4bc4ef1f5",
    name: "Obsessive-compulsive disorder(OCD)",
    description: "Some text about the product..",
    link:`https://www.google.com/search?q=ocd&rlz=1C1VDKB_enIN943IN943&sxsrf=APwXEdepTznWa8WIdXLuJGBfsPgfHsF4aw%3A1683475669884&ei=1cxXZMTTNa7z4-EPwtCd4Aw&ved=0ahUKEwiEkqrKy-P-AhWu-TgGHUJoB8wQ4dUDCA8&uact=5&oq=ocd&gs_lcp=`,
  ...
  },
  {
    id: 7,
    imageurl:
      "https://images.unsplash.com/photo-1495996146452-1737b3678c78?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1174&q=80",
    name: "Bipolar disorder",
    description: "Some text about the product..",
    link:`https://www.google.com/search?q=bipolar+disorder&rlz=1C1VDKB_enIN943IN943&sxsrf=APwXEdd6V2MgNJcJrHvvFuj1GU77QBl3gQ%3A1683475695189&ei=78xXZOSbC-704-EPj6G7mA8&oq=bipolar+di&gs_lcp=&
    `,
  ...
  },
  {
    ...
    name: "Learn More",
    description: "Some text about the product..",
    link:`https://www.google.com/search?q=how+to+be+mentally+healthy&rlz=1C1VDKB_enIN943IN943&sxsrf=APwXEdfa6aOfbpEJsofF_xfRzdM1O0elyA%3A1683475731750&ei=E81XZLa6LYLr-AbpuJ_wAg&oq=how+to+be+mental&gs_lcp=&sclient=gws-wiz-serp`,
